...
export default function Navbar({ isOpen, onOpen, onClose }) {
  return (
    ...
    >
      ...
      >
        <div className="grid h-10 w-10 shrink-0 place-items-center rounded-lg bg-[#10213D] text-white">
          <Utensils size={20} />
        </div>
        {isOpen && (
          <div className="min-w-0">
            <p className="truncate text-base font-bold text-[#10213D]">Soscio</p>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              [
                ...
                isActive
                  ? 'bg-[#10213D] text-white shadow-sm'
